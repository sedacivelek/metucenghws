...
USER_SIGNIN_FAILED = "There is no user with such ID."
...
NOT_ENOUGH_SCORE = "You don’t have enough score for coupons."

SUBSCRIBE_MEMBERSHIP_NOT_FOUND = "Membership is not found."
SUBSCRIBE_MAX_PARALLEL_SESSIONS_UNAVAILABLE = "New membership's max parallel sessions must be greater than or equal to current membership's max parallel sessions."
