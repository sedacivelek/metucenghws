...
## You can see the information comments where instructions are added.
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	  IOPQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ, IIADDQ }; #iaddq instruction is addded
...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
		     IIRMOVQ, IRMMOVQ, IMRMOVQ, IIADDQ }; #iaddq instruction is addded


# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL, IIADDQ }; #iaddq instruction is addded
...
word d_srcB = [
	D_icode in { IOPQ, IRMMOVQ, IMRMOVQ ,IIADDQ  } : D_rB; #iaddq instruction is addded
...
word d_dstE = [
	D_icode in { IRRMOVQ, IIRMOVQ, IOPQ, IIADDQ} : D_rB; #iaddq instruction is addded
...
word aluA = [
	...
	E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IIADDQ} : E_valC; #iaddq instruction is addded
...
word aluB = [
	E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
		     IPUSHQ, IRET, IPOPQ, IIADDQ } : E_valB; #iaddq instruction is addded
...
bool set_cc = E_icode in {IOPQ, IIADDQ} &&
	...
	!m_stat in { SADR, SINS, SHLT } && !W_stat in { SADR, SINS, SHLT }; #iaddq instruction is addded (tricky part: I added instruction in this part to use 
									    #iaddq instead of using andq's).
